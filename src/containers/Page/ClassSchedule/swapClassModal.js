...
import { toggleSwapClassModal, } from '../../../redux/ui/actions';
...
const SwapClassModal = Form.create()(
  class extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
      ...
      if (nextProps.open && !this.props.putUpdateApplicationFetched && nextProps.putUpdateApplicationFetched) {
    ...
    handleClose = () => {
      const { toggleSwapClassModal } = this.props;
...
export default injectIntl(connect(
  state => ({
    ...
    open: state.toggleSwapClassModal.open,
    applicationSessionId: state.toggleSwapClassModal.applicationSessionId,
  }),
  {
