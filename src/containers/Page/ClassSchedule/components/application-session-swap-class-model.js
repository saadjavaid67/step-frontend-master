...
function ApplicationSessionSwapClassModal({ form, ...rest }) {
    ...
    const info = useSelector(state => state.toggleApplicationSessionSwapClassModal.info);
            ...
            {session && <Form>
                ...
                >
                    {getFieldDecorator('course_class_id', {
                        ...
                        <CourseClassSelect onChange={(value) => setCourseClassId(value)} type='GENERAL' />
                    )}
                </FormItem>
                {
